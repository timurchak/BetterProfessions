...
local english = {
    ...
    REWARDS = "Rewards",
    RECIPE_NOT_LEARNED = "Recipe not learned",
    ...
    DOCK_PANEL = "Attach to profession window",
    UNDOCK_PANEL = "Detach from profession window",
    DOCK_PANEL_HINT = "Attaches to the nearest right corner.",
...
local russian = {
    ...
    REWARDS = "Награды",
    RECIPE_NOT_LEARNED = "Рецепт не изучен",
    ...
    DOCK_PANEL = "Прицепить к окну профессии",
    UNDOCK_PANEL = "Отцепить от окна профессии",
    DOCK_PANEL_HINT = "Панель прицепится к ближайшему правому углу.",
